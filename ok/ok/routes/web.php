...
Route::group(['prefix' => 'admin', 'middleware' => 'soloadmin'], function () {
    ...
    Route::post('/index', [App\Http\Controllers\Admin\AdminController::class, 'index'])->name('admin.admin');

    Route::get('/control', [App\Http\Controllers\Admin\formPresidentController::class, 'index'])->name('admin.formPresident');
