...
use App\Http\Controllers\Admin\crudSancion;
...
/* RUTA ADMINISTRADOR*/
 ...
 Route::group(['prefix' => 'admin', 'middleware' => 'soloadmin'], function () {
    Route::get('/index', [App\Http\Controllers\Admin\AdminController::class, 'index'])->name('admin.index');
     ...
     //CREACION PRESIDENTE 
     Route::get('/crudPresident/index', [App\Http\Controllers\Admin\crudPresident::class, 'index'])->name('admin.crudPresident');
    ...
    //CREACION EQUIPO
     Route::get('/crudEquipo/index', [App\Http\Controllers\Admin\crudEquipo::class, 'index'])->name('admin.crudEquipo');
     ...
     //CREACION PARTIDO
     Route::get('/crudPartido/index', [App\Http\Controllers\Admin\crudPartido::class, 'index'])->name('admin.crudPartido.index');
     ...
     //CREACION SANCION
     Route::get('/crudSancion/index', [App\Http\Controllers\Admin\crudSancion::class, 'index'])->name('admin.crudSancion.index');
     Route::post('/crudSancion/index', [App\Http\Controllers\Admin\crudSancion::class, 'index'])->name('admin.crudSancion.index');
     Route::get('/crudSancion/create', [App\Http\Controllers\Admin\crudSancion::class, 'create'])->name('admin.formSancion.create');
     #Route::post('/crudSancion/create', [App\Http\Controllers\Admin\crudSancion::class, 'create'])->name('admin.formSancion.create');
 
     Route::post('/crudSancion/create', [crudSancion::class, 'store'])->name('sancion.create'); 
     Route::patch('/crudSancion/{id}', [crudSancion::class, 'update'])->name('sancion.update');
     Route::delete('/crudSancion/{id}', [crudSancion::class, 'destroy'])->name('sancion.delete');
