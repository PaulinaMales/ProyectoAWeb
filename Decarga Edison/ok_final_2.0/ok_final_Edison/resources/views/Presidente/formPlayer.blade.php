          ...
          <div class="card-body p-4 p-md-5">
            ...
            @endif            
              ...
              <div class="row">
                <div class="col-md-6 mb-4 pb-2">
                  <div class="form-outline">
                    <input type="number" id="num_camiseta" class="form-control form-control-lg" name="num_camiseta"/>
                    <label class="form-label text-black" for="num_camiseta">N° de Camiseta</label>
                  </div>
                </div>
              </div>              
          <!-- Type input -->
